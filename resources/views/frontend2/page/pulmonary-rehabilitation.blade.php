...
@section('content')
    ...
    <div class="headingMain">
        ...
        <p>Dr Sirshendu Ray of Dr. Ray's Pulmonary Rehabilitation is associated with 60 Plus Care provides best pulmonary rehabilitation doctors in kolkata.</p>
        <p>
                ...
                <div class="row">
                    <div class="col-xl-6 text-center">
                        <div class="prt_single_image-wrapper">
                            <img width="100%" height="auto" class="img-fluid rounded" src="{{ asset('static/images/60-plus-care-pulmonary-rehabilitation-in-kolkata.jpg') }}" alt="Pulmonary Rehabilitation Service at {{ env('APP_NAME') }}">
                        </div>
                    </div>
                    <div class="col-xl-6 align-self-center">
                        <div class="pl-30 res-1199-pl-0 res-1199-mt-30">
                            ...
                            <div class="section-title mb-30">
                                ...
                                <div class="title-desc">
                                    <p class="pb-10">
                                        Initiated by <strong>Dr. Dipankar Debnath</strong>, 60 Plus Care is one of the best Pulmonary Rehabilitation Centre in Kolkata providing <strong>best lung rehab solutions in Kolkata</strong>.
