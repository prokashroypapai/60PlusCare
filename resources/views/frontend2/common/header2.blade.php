                    ...
                    <div class="d-flex flex-row align-items-center justify-content-between header-spacing">
                        ...
                        <div class="align-self-center">
                            <ul class="social-icons">
                                <li>
                                    <a href="https://twitter.com/the60pluscare" aria-label="twitter" title="{{env('APP_NAME')}} on X (Twitter)" target="_blank">
                                        <img loading="lazy" src="{{asset('static/images/x.png')}}" width="30" height="30" alt="{{env('APP_NAME')}} on X (Twitter)">
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                <nav class="main-menu menu-mobile" id="menu">
                                    <ul class="menu slide-menu">
                                        ...
                                        <li class="mega-menu-item">
                                            <a href="{{url('/pulmonary-rehabilitation')}}" title="Best Pulmonary Rehabilitation Services provided by {{ env('APP_NAME') }}">Pulmonary Rehab</a>
                                        </li>
                                        <li class="mega-menu-item">
