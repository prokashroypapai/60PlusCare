<section class="prt-row home02-team-section bg-white clearfix">
    <div class="container" data-aos="fade-up">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="row slick_slider team-01 mt_15" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "arrows":false, "autoplay":true, "dots":false, "infinite":true, "responsive":[{"breakpoint":992,"settings":{"slidesToShow": 3}},{"breakpoint":767,"settings":{"slidesToShow": 2}},{"breakpoint":575,"settings":{"slidesToShow": 1}},{"breakpoint":480,"settings":{"slidesToShow": 1}}]}'>

                    <div class="col-lg-4">
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img loading='lazy' class="img-fluid" src="{{asset('static/images/dr-dipankar-debnath.jpg')}}" width="277" height="301" alt="Dr Dipankar Debnath {{env('APP_NAME')}}">
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                    <strong><a href="#">Dr Dipankar Debnath</a></strong>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img loading='lazy' class="img-fluid" src="{{asset('static/images/Koushik-Nath.jpg')}}" width="277" height="301" alt="Koushik Nath on {{env('APP_NAME')}}">
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                    <strong rel="nofollow"><a href="#">Koushik Nath</a></strong>
                                </div>
                                <div class="featured-desc mt-2">
                    ...
                    <div class="col-lg-4">
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img loading="lazy" class="img-fluid" src="{{asset('static/images/Saibal_Dhar.jpg')}}" width="277" height="301" alt="Saibal Dhar supporting staff at {{env('APP_NAME')}}">
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                    <strong><a href="#">Saibal Dhar</a></strong>
                                </div>
                                <div class="featured-desc mt-2">
                    ...
                    <div class="col-lg-4">
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img loading="lazy" class="img-fluid" src="{{asset('static/images/Raj_Hossain.jpg')}}" width="277" height="301" alt="Raj Hossain supporting staff at {{env('APP_NAME')}}">
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                    <strong><a href="#">Raj Hossain</a></strong>
                                </div>
                                <div class="featured-desc mt-2">
                    ...
                    <div class="col-lg-4">
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img loading="lazy" class="img-fluid" src="{{asset('static/images/milan-chakraborty.jpg')}}" width="277" height="301" alt="Milan Chakraborty Advisor at {{env('APP_NAME')}}">
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                    <strong><a href="#">Milan Chakraborty</a></strong>
                                </div>
                                <div class="featured-desc mt-2">
                                    <p>Advisor; Growth & Development, Founder & Director of Advantage Bengal Infrastructure Limited</p>
                                </div>
                            </div>
                        </div>
                    </div>
