...
<head>
    ...
    <!--favicon icons-->
    <link rel="apple-touch-icon-precomposed" sizes="192x192" href="{{asset('static_BAK/images/ico/apple-touch-icon-192-precomposed.png')}}"/>
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('static_BAK/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('static_BAK/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('static_BAK/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="{{asset('static_BAK/images/ico/apple-touch-icon-57-precomposed.png')}}">

    <link rel="shortcut icon" type="image/x-icon" href="{{asset('static_BAK/images/ico/favicon.png')}}" />
    ...
    <link rel="preload" href="{{asset('static_BAK/css/main.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{asset('static_BAK/css/main.css')}}"></noscript>
    ...
    <script type="application/ld+json">
    {
        ...
        "logo": "{{asset('static_BAK/images/logo.webp')}}",
        "sameAs": [
...
<style>
    #load{
        ...
        position:fixed;
        z-index:9999;
        background:url("/static_BAK/images/loader-logo.png") no-repeat center center rgba(255,255,255,1)
    }
</style>
<script>
...
<div class="page">
    ...
    @include('frontend2.common.header2')

    @yield('content')

<!-- footer start -->
    @include('frontend2.common.footer')
    <!-- footer end -->
...
<div class="sidebarItem">
    <div class="social emergency">
        <a href="#" target="_blank" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <p>
                Emergency
                <img loading="lazy" src="{{ asset('static_BAK/images/red-cross-emergency.gif') }}" width="40" height="auto" alt="emergency icon of {{env('APP_NAME')}}"/>
            </p>
        </a>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    ...
                    <img loading="lazy" src="{{ asset('static_BAK/images/red-cross-emergency.gif') }}" width="40" height="auto" alt="Emergency Banner of {{env('APP_NAME')}}"/>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="col-12 py-3 border-bottom">
                    <img loading="lazy" src="{{ asset('static_BAK/images/call-ambulance.jpg') }}" class="img-fluid" onclick='window.location.href="tel:+918296111777"' alt="Ambulance Calling banner of {{env('APP_NAME')}}"/>
                </div>
                <div class="col-12 py-3 border-bottom">
                    <img loading="lazy" src="{{ asset('static_BAK/images/call-doctor.jpg') }}" class="img-fluid" onclick='window.location.href="tel:+918296111777"' alt="Doctor Calling Banner of {{env('APP_NAME')}}"/>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    //loadjscssfile("{{asset('static_BAK/css/all.min.css')}}", "css")
    loadjscssfile("{{asset('static_BAK/css/slick.css')}}", "css")
    loadjscssfile("{{asset('static_BAK/css/shortcodes.css')}}", "css")
    loadjscssfile("{{asset('static_BAK/css/responsive.css')}}", "css")
    loadjscssfile("{{asset('static_BAK/css/megamenu.css')}}", "css")


    loadjscssfile("{{asset('static_BAK/js/main.js')}}", "js")
    loadjscssfile("{{asset('static_BAK/js/slick.min.js')}}", "js")
