            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Create Gallery</h4>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{url('admin/gallery/store')}}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" id="gallery_name" name="gallery_name" class="form-control" value="{{old('gallery_name')}}">
                                </div>
