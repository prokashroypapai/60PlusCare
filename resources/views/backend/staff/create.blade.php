            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Create Staff</h4>
                            ...
                            <form method="post" action="{{url('admin/staff/store')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" id="permission" name="permission" class="form-control">
                                        <option value="{{\App\Models\User::PERMISSION_ADMIN}}" @if(old('permission') == \App\Models\User::PERMISSION_ADMIN) selected @endif>ADMIN</option>
                                        <option value="{{\App\Models\User::PERMISSION_MANAGER}}" @if(old('permission') == \App\Models\User::PERMISSION_MANAGER) selected @endif>MANAGER</option>
                                        <option value="{{\App\Models\User::PERMISSION_MEMBER}}" @if(old('permission') == \App\Models\User::PERMISSION_MEMBER) selected @endif>MEMBER</option>
                                    </select>
                                </div>
