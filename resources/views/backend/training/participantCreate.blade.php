            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Create Participant</h4>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{url('admin/participantStore')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="training_id" value="{{ app('request')->input('trainingId') }}">

                                <div class="form-group">
                                    <label for="upload">Upload Certificate (optional)</label>
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" id="certificate_no" name="certificate_no" class="form-control" placeholder="Enter Certificate no" value="{{old('certificate_no')}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" id="dob" name="dob" class="form-control datepicker" placeholder="Enter dob" value="{{ old('dob') ? old('dob') : null }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="is_eligible" name="is_eligible" class="form-control">
                                        <option value="1" @if(old('is_eligible') == \App\Models\Activity\Participant::ELIGIBLE_YES) selected @endif>YES</option>
                                        <option value="0" @if(old('is_eligible') == \App\Models\Activity\Participant::ELIGIBLE_NO) selected @endif>NO</option>
                                    </select>
                                </div>
                                ...
                                <div style="position: absolute; float: right; right: 0; top: 0">
                                    <span class="btn btn-success waves-effect waves-light" onclick='window.location.href="{{ url('/admin/training/' . app('request')->input('trainingId')) }}"'>Back to Training</span>
                                </div>
                            </form>
                        </div>
                    </div>
