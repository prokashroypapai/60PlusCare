                ...
                <div class="row mt_15 justify-content-center">
                    ...
                    <div class="col-10 py-3 mt-4 bg-white" style="overflow-x:auto;">
                        ...
                        <table class="table table-bordered myTable" border="1">
                            ...
                            <tr class="bg3">
                                <th colspan="6" style="text-align: center">DOCTOR's VISIT</th>
                            </tr>
                            <tr>
                            ...
                            <tr class="bg3">
                                <th colspan="6" style="text-align: center">GERIATRIC / ELDER CARE MANAGER VISIT</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="4" align="center">
                                    ₹600 for initial 1.5 Hours then ₹300 per Additional Hours
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr class="bg3">
                                <th colspan="6" style="text-align: center">OTHER SERVICES</th>
                            </tr>
                            <tr class="bg2">
                            ...
                            <tr>
                                <td style="background-color: #f1ffc5">Comprehensive Blood Test ₹4300</td>
                                <td>
                                    4 per Year
                            ...
                            <tr>
                                ...
                                <td colspan="6" align="center" style="background-color: #b2ffae">
                            ...
                            <tr>
                                <td style="background-color: #f1ffc5">CCTV Monitoring System</td>
                                <td colspan="6">
                                    As per cost and package
                                </td>
                            </tr>
                            <tr>
                                <td style="background-color: #f1ffc5">DOCTORS Home Visit – GP only</td>
                                <td colspan="6">
                            ...
                            <tr>
                                <td style="background-color: #f1ffc5">Nurse / Male Nurse / Brother</td>
                                <td colspan="6">
                                    Starting from Regular ₹850 ICU / Premium ₹950 per 12 Hours
                                </td>
                            </tr>
                        </table>
                        <!--<p class="conditionApply">
                            *Popular Package - ₹7000 for a year + Registration Charges + GST extra, <span class="text-danger">NO YEARLY RENEWAL CHARGES</span><br/>
                            Package consist of - MEAS – 24x7 Medical Emergency Assistance Service, Regular Telecalling once a week, Supervisor visit
                        </p>-->
                        <p class="conditionApply">
                            * Conditions Apply. Rates applicable for Kolkata, Salt lake, New Town, Garia (Effective 1st October 2024)<br>
