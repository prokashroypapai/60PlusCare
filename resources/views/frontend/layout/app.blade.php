...
<head>
    ...
    <meta name="copyright" content="Copyright 2024 - {{ env('APP_NAME') }}"/>
  ...
  "@graph": [
    {
      ...
      "@id": "{{ URL::current() }}",
      "url": "{{ URL::current() }}",
      "name": "{{ isset($metaseo['meta_title']) ? $metaseo['meta_title'] : '60 Plus Care - Most Trusted Elder Care at Home' }}",
      "isPartOf": {
        "@id": "https://60pluscare.in/#website"
      },
      "about": {
        "@id": "https://60pluscare.in/#organization"
      },
      "datePublished": "2022-07-21T19:04:00+00:00",
      "dateModified": "2024-09-01T11:53:01+00:00",
      "description": "{{ isset($metaseo['meta_description']) ? $metaseo['meta_description'] : 'Personalized Elder Care Services in Kolkata for Seniors. Get Assisted Living Facility, 360 Degree Medical Care at Home' }}",
      "breadcrumb": {
        "@id": "https://60pluscare.in/#breadcrumb"
      },
      "inLanguage": "en-US",
      "potentialAction": [
        {
    ...
    },
    {
      ...
      "name": "60 Plus Care",
      "description": "Elder Care at Home",
      "publisher": {
        "@id": "https://60pluscare.in/#organization"
      },
      "potentialAction": [
        {
          ...
          "target": {
            "@type": "EntryPoint",
            "urlTemplate": "https://60pluscare.in/?q={search_term_string}"
          },
    ...
    },
    {
      ...
      "logo": {
        "@type": "ImageObject",
        "inLanguage": "en-US",
        "@id": "https://60pluscare.in/#/schema/logo/image/",
        "url": "{{asset('static/images/logo.webp')}}",
        "contentUrl": "{{asset('static/images/logo.webp')}}",
        "width": 640,
        "height": 355,
        "caption": "60 Plus Care"
      },
      "image": {
        "@id": "https://60pluscare.in/#/schema/logo/image/"
      },
...
<!-- footer start -->
    ...
    <!-- back-to-top start -->
    <a id="totop" href="#top" title="Back to Top Button">
...
<div class="sidebarItem">
    <div class="social emergency">
        <a target="_blank" data-bs-toggle="modal" data-bs-target="#exampleModal" title="Emergency help at {{ env('APP_NAME') }}">
            <p>
                Emergency
    ...
    <div class="social whatsapp">
        <a href="https://api.whatsapp.com/send?phone=918296111777" target="_blank" title="Whatsapp at {{ env('APP_NAME') }}">
            <p>Whatsapp
    ...
    <div class="social call">
        <a href="tel:+918296111777" target="_blank" title="Customer Support at {{ env('APP_NAME') }}">
            <p>Call Now
