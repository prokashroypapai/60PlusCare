...
<style>
    ...
    .noticeBoard strong{width: 100%; display: block; background-color: #455c17;color: #fff;padding: 10px 5px;}
    .noticeBoard strong{font-size: 20px;line-height: 26px;}
