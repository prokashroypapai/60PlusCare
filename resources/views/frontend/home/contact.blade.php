<section class="prt-row service01-our-contact-section bg-base-skin-Primary clearfix">
    <div class="container">
        <div class="row prt-vertical_sep">
                ...
                <div class="featured-icon-box style7">
                    ...
                    <div class="featured-content">
                        ...
                        <div class="featured-desc">
                            <p class="text-dark">
                                <a href="https://wa.me/918296111777" title="Whatsapp No of {{env('APP_NAME')}}">Whatsapp us</a> your query. We will discuss with you.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="featured-icon-box style7">
                    ...
                    <div class="featured-content">
                        <div class="featured-title">
                            <span>Call us Any Question?</span>
                        </div>
                        <div class="featured-desc">
                            <p class="text-dark">Get 24/7 Emergency <br>Call us: <a href="tel:8296 111 777" title="Customer Care number of {{env('APP_NAME')}}">(+91) 8296 111 777</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="featured-icon-box style7">
                    ...
                    <div class="featured-content">
                        <div class="featured-title">
                            <span>Register for Elder Care Services!</span>
                        </div>
                        <div class="featured-desc">
                            <p><a href="{{url('register')}}" title="Register at {{env('APP_NAME')}}">Register Now</a></p>
                        </div>
                    </div>
                </div>
            </div>
